...
jQuery(document).ready(function() {
    jQuery('#submit_ticket').click(function() {
			...
			var start_location = jQuery('#start_location').val();
			var end_location = jQuery('#end_location').val();
